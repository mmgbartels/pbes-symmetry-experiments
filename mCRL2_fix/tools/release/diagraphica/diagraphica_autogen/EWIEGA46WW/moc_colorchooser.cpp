...
QT_MOC_LITERAL(23, 0), // ""
QT_MOC_LITERAL(24, 11) // "deactivated"

    },
    "ColorChooser\0activated\0\0deactivated"
};
...
void ColorChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ColorChooser::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorChooser::activated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ColorChooser::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorChooser::deactivated)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<ColorChooser, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void ColorChooser::activated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ColorChooser::deactivated()
{
