...
QT_MOC_LITERAL(6, 17), // "clusteringChanged"
QT_MOC_LITERAL(24, 0), // ""
QT_MOC_LITERAL(25, 16), // "deletedAttribute"
QT_MOC_LITERAL(42, 9) // "recluster"

    },
    "Graph\0clusteringChanged\0\0deletedAttribute\0"
    "recluster"
};
...
void Graph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->clusteringChanged(); break;
        case 1: _t->deletedAttribute(); break;
        case 2: _t->recluster(); break;
        default: ;
        }
        ...
        {
            using _t = void (Graph::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Graph::clusteringChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Graph::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Graph::deletedAttribute)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Graph, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void Graph::clusteringChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Graph::deletedAttribute()
{
