...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_CombnPlot_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_CombnPlot_t qt_meta_stringdata_CombnPlot = {
    {
QT_MOC_LITERAL(0, 9) // "CombnPlot"
...
const QMetaObject CombnPlot::staticMetaObject = { {
    QMetaObject::SuperData::link<Visualizer::staticMetaObject>(),
    qt_meta_stringdata_CombnPlot.offsetsAndSize,
    qt_meta_data_CombnPlot,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_CombnPlot_t
, QtPrivate::TypeAndForceComplete<CombnPlot, std::true_type>
